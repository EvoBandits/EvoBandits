...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(0.0, 1, {}, None, None, None, marks=xTypeErr, id="f_type_low"),
        pytest.param(0, 1.0, {}, None, None, None, marks=xTypeErr, id="f_type_high"),
        pytest.param(0, 0, {}, None, None, None, marks=xValueErr, id="f_value_low_high"),
        pytest.param(0, 1, {"size": 2.0}, None, None, None, marks=xTypeErr, id="f_type_size"),
        pytest.param(0, 4, {"step": 2.0}, None, None, None, marks=xTypeErr, id="f_type_step"),
